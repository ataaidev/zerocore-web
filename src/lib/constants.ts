...
export const SOCIAL_LINKS = {
  twitter: 'https://twitter.com/zerocoregroup',
  linkedin: 'https://linkedin.com/company/zerocoregroup',
  github: 'https://github.com/zerocoregroup'
};

// Navigation links (for future use if needed)
